...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-ee-lg rounded-es-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-ss-lg lg:rounded-ee-none lg:p-20"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ms-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4"
                                >
                        ...
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:start-[0.4rem] before:top-0 before:bottom-1/2 before:border-l before:border-[#e3e3e0]"
                        >
                            <span class="relative bg-white py-1">
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]"
                ...
                <div
                    class="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ms-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-e-lg! lg:rounded-t-none"
                >
                    {{-- Laravel Logo --}}
                    <svg
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg
                        class="relative -ms-8 -mt-[4.9rem] w-[448px] max-w-none lg:ms-0 lg:-mt-[6.6rem]"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg
                        class="relative -ms-8 -mt-[4.9rem] hidden w-[448px] max-w-none lg:ms-0 lg:-mt-[6.6rem]"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <div
                        class="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-e-lg lg:rounded-t-none"
                    ></div>
                </div>
            </main>
        </div>
